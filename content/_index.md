...
Currently, I work as a *Principal Software Engineer at [VMware by Broadcom][vmware-broadcom]*, where I work on making the Kubernetes distribution the best in the world. My focus is on performance, scale, and long term support of the product.

Previously, I used to work in the [Tanzu by Broadcom][tanzu-broadcom] where I used to lead a few functions of the multi-tenant control plane powering the products. My primary focus was to ensure safeguard API quality, scale out the control plane, and own any area related to open source projects that are used, such as [KCP][kcp].

I'm honored to serve as the **Chair of the Kubernetes Special Interest Group Contributor Experience**. Over the past years, I have actively participated in the Kubernetes community, wearing multiple hats to contribute to the project's stability and sustainability. As a **Kubernetes Release Manager**, I have been involved in releases since Kubernetes 1.17, and I **led the Kubernetes 1.22 Release Team**. I was also **an elected member of the Kubernetes Steering Committee** from 2022 to 2024. I've been awarded multiple times to receive recognition for my contributions, with my work even being **featured in national newspapers** in India.
